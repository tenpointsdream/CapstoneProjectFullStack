...
//	}
	public static void main(String[] args) {
		...
		questionService.addQuestion(new Question("Test description", "test.jpg", "04-26-2023, 12:36", false,
				"JavaScript", "Getting to know", null, users.get(1), null));
		questionService.addQuestion(new Question("Test description", "test.jpg", "04-26-2023, 12:36", true, "Angular",
				"What is Angular?", null, users.get(1), users.get(0)));
		questionService.addQuestion(new Question("Test description", "test.jpg", "04-26-2023, 12:36", false, "Java",
		...
		answerService.addAnswer(new Answer("I don't really know", "smileyface.jpg", false, "04-30-2023, 23:14",
				questions.get(1), null, users.get(2)));
		answerService.addAnswer(new Answer("I doubt it", "smileyface.jpg", false, "04-30-2023, 23:14",
				questions.get(1), null, users.get(2)));
		answerService.addAnswer(new Answer("I know it", "smileyface.jpg", true, "04-30-2023, 23:14",
				questions.get(1), users.get(0), users.get(2)));
